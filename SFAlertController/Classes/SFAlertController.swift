...
public class SFAlertController: UIViewController {
    ...
    private lazy var header: SFAlertHeaderView = {
        $0.backgroundColor = UIColor.white
        $0.isHidden = true
        return $0
    }(SFAlertHeaderView(spacing: spacing))
    /// 自定义的view
    ...
    private lazy var buttonsView: UITableView = {
        ...
        $0.register(SFAlertCell.self, forCellReuseIdentifier: SFAlertCell.identifier)
        return $0
    ...
    private var maxWidth: CGFloat {
        return preferredStyle == .alert
            ? maxAlertWidth
            : (UIScreen.main.bounds.width - sheetInsets.left - sheetInsets.right)
    }
...
extension SFAlertController {
    ...
    public static func show(in viewController: UIViewController? = UIApplication.shared.keyWindow?.rootViewController,
        ...
        let alertController = SFAlertController(title: title,
                                                    message: message,
...
extension SFAlertController: UITableViewDataSource {
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return columns
    }
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: SFAlertCell.identifier) as? SFAlertCell else {
            fatalError()
        }
...
extension SFAlertController: UITableViewDelegate {
...
/// private
private extension SFAlertController {
    ...
    private func configContainerView() {
        ...
        if preferredStyle == .alert {
            ...
            containerViewBottomConstriant = containerView.bottomAnchor.constraint(equalTo: view.bottomAnchor,
                                                                                  constant: -sheetInsets.bottom)
    ...
    private func configContentView() {
        ...
        contentView.topAnchor.constraint(equalTo: containerView.topAnchor,
                                         constant: shouldConfigHeader ? spacing : 0).isActive = true
        ...
        contentView.bottomAnchor.constraint(equalTo: containerView.bottomAnchor,
                                            constant: buttons.isEmpty ? -spacing  : 0).isActive = true
    ...
    private func configHeader() {
        ...
        /// 计算高度
        let customViewSize = header.systemLayoutSizeFitting(
